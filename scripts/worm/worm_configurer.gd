...
@export var config_worm_controls_info: Control
@export var worm_controls_info: Control
...
func _set_config_mode(value):
	...
	if is_inside_tree():
		config_worm_controls_info.visible = _in_config_mode
		worm_controls_info.visible = not _in_config_mode
